...
export class PossibleRolls {
    ...
    private _dice: Dice<RollResult[]> = {
            blue: [
                ...
                new RollResult(true , 0, 0, 0, 0, 1 / 6),
                new RollResult(false, 2, 1, 2, 0, 1 / 6),
                new RollResult(false, 2, 0, 3, 0, 1 / 6),
                new RollResult(false, 2, 0, 4, 0, 1 / 6),
                new RollResult(false, 1, 0, 5, 0, 1 / 6),
                new RollResult(false, 1, 1, 6, 0, 1 / 6)
            ],
            red: [
                new RollResult(false, 1, 0, 0, 0, 1 / 6),
                new RollResult(false, 2, 0, 0, 0, 3 / 6),
                new RollResult(false, 3, 0, 0, 0, 1 / 6),
                new RollResult(false, 3, 1, 0, 0, 1 / 6)
            ],            
            yellow: [
                new RollResult(false, 0, 1, 1, 0, 1 / 6),
                new RollResult(false, 1, 0, 1, 0, 1 / 6),
                new RollResult(false, 1, 0, 2, 0, 1 / 6),
                new RollResult(false, 1, 1, 0, 0, 1 / 6),
                new RollResult(false, 2, 0, 0, 0, 1 / 6),
                new RollResult(false, 2, 1, 0, 0, 1 / 6)
            ],
            green: [
                new RollResult(false, 1, 0, 0, 0, 1 / 6),
                new RollResult(false, 0, 1, 0, 0, 1 / 6),
                new RollResult(false, 0, 1, 1, 0, 1 / 6),
                new RollResult(false, 1, 0, 1, 0, 1 / 6),
                new RollResult(false, 1, 1, 0, 0, 1 / 6),
                new RollResult(false, 1, 1, 1, 0, 1 / 6)
            ],            
            brown: [
                new RollResult(false, 0, 0, 0, 0, 3 / 6),
                new RollResult(false, 0, 0, 0, 1, 2 / 6),
                new RollResult(false, 0, 0, 0, 2, 1 / 6),
            ],
            grey: [
                new RollResult(false, 0, 0, 0, 0, 1 / 6),
                new RollResult(false, 0, 0, 0, 1, 3 / 6),
                new RollResult(false, 0, 0, 0, 2, 1 / 6),
                new RollResult(false, 0, 0, 0, 3, 1 / 6),
            ],
            black: [
                new RollResult(false, 0, 0, 0, 0, 1 / 6),
                new RollResult(false, 0, 0, 0, 2, 3 / 6),
                new RollResult(false, 0, 0, 0, 3, 1 / 6),
                new RollResult(false, 0, 0, 0, 4, 1 / 6)
            ] 
    }
